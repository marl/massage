...
class TestGuitarStrummer(TestCase):
    ...
    def test_run(self):
        ...
        print('jams dur: {}'.format(jams_out.file_metadata['duration']))
        print('audio dur: {}'.format(y_stereo.shape[1]/float(fs)))
        self.assertGreaterEqual(
            y_stereo.shape[1]/float(fs), jams_out.file_metadata['duration'])
